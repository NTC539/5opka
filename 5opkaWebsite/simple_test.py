...
class TestEmailValidation(unittest.TestCase):
    ...
    def test_invalid_emails(self):
        ...
        list_mail_uncor = [
            ...
            "1",                            # 2. одно число
            "m1@",                          # 3. нет домена
            "@mail.ru",                     # 4. нет локальной части
            "m1@mail",                      # 5. нет точки в домене
            "m1@.ru",                       # 6. пустое доменное имя
            "m1@mail.c",                    # 7. домен верхнего уровня из 1 символа
            "m1@@mail.ru",                  # 8. две собаки
            "m 1@mail.ru",                  # 9. пробел в локальной части
            ".m1@mail.ru",                  # 10. точка в начале локальной части
            "m1@mail..ru",                  # 11. две точки подряд в домене
            ...
            "m1@yandex.com",                # 18. домен не из списка
